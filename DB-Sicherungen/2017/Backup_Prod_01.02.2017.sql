...
-- Started on 2017-02-01 21:09:18
...
SELECT pg_catalog.setval('address_address_id_seq', 670, true);
...
SELECT pg_catalog.setval('article_article_id_seq', 859, true);
...
SELECT pg_catalog.setval('city_city_id_seq', 146, true);
...
969	185	11	greta.hauswiesner@view-salzburg.at
839	307	10	lixl.hubert@tele2.at
970	185	10	grete.hauswiesner@hotmail.com
...
937	44	10	anita.bernhofer@sol.at
...
947	253	10	albert.kiefel@gmail.com
948	253	11	albert.kiefel@view-salzburg.at
...
SELECT pg_catalog.setval('email_email_id_seq', 973, true);
...
SELECT pg_catalog.setval('incoming_article_incoming_article_id_seq', 858, true);
...
366	141	642	0	2016-12-15	WP L 120	2017-01-28	1
...
368	119	602	0	2016-10-27	WP S 126	2017-02-01	1
369	119	602	0	2016-10-21	WP S 128	2017-02-01	1
371	288	602	0	2016-09-01	WP S 127	2017-02-01	0
...
SELECT pg_catalog.setval('incoming_delivery_incoming_delivery_id_seq', 372, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 5397, true);
...
SELECT pg_catalog.setval('organisation_organisation_id_seq', 289, true);
...
SELECT pg_catalog.setval('outgoing_article_outgoing_article_id_seq', 1928, true);
...
845	148	642	\N	0	2016-12-13		2017-01-28	0
...
847	192	642	\N	0	2016-12-20		2017-01-28	0
...
854	209	642	\N	0	2016-11-10		2017-01-28	0
...
863	126	602	\N	0	2016-10-04		2017-02-01	0
864	280	602	\N	0	2016-10-23		2017-02-01	1
865	287	602	\N	0	2016-08-10		2017-02-01	0
...
SELECT pg_catalog.setval('outgoing_delivery_outgoing_delivery_id_seq', 872, true);
...
44	2	31	221	252	Frau		Anita	Bernhofer	Tätigkeit: Administration	2016-12-03	1
...
185	2	42	127	519	Frau		Greta	Hauswiesner	Tätigkeit: Admin.;Newsletter: ja	2017-01-13	1
...
253	3	134	660	253	Herr	DI	Albert	Kiefel	Tätigkeit: Administration	2016-02-04	1
...
673	\N	42	113	252	Frau	Mag.	Friederike	Hurch	02.04.2012	2016-12-30	1
...
734	2	42	669	253	Herr	Mag.	Harald	Kratzer		2017-02-01	1
...
SELECT pg_catalog.setval('person_person_id_seq', 735, true);
...
862	44	10	0650/5207421
861	44	10	0650/5207421
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 885, true);
...
-- Completed on 2017-02-01 21:10:29
