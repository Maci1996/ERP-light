...
-- Started on 2017-06-08 18:35:57
...
SELECT pg_catalog.setval('address_address_id_seq', 687, true);
...
SELECT pg_catalog.setval('article_article_id_seq', 930, true);
...
SELECT pg_catalog.setval('city_city_id_seq', 149, true);
...
1077	533	10	gsulzer@foto-sulzer.at
...
SELECT pg_catalog.setval('email_email_id_seq', 1078, true);
...
SELECT pg_catalog.setval('incoming_article_incoming_article_id_seq', 929, true);
...
SELECT pg_catalog.setval('incoming_delivery_incoming_delivery_id_seq', 405, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 5987, true);
...
SELECT pg_catalog.setval('organisation_organisation_id_seq', 299, true);
...
SELECT pg_catalog.setval('outgoing_article_outgoing_article_id_seq', 2102, true);
...
SELECT pg_catalog.setval('outgoing_delivery_outgoing_delivery_id_seq', 947, true);
...
533	\N	\N	\N	252	Herr		Gerhard	Sulzer Sen.		2017-06-07	1
...
SELECT pg_catalog.setval('person_person_id_seq', 756, true);
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 988, true);
...
-- Completed on 2017-06-08 18:36:31
