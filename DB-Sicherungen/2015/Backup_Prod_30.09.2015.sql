...
-- Started on 2015-09-30 17:08:12
...
SELECT pg_catalog.setval('address_address_id_seq', 588, true);
...
345	Bananenkleie	Pkg.	0.0840000000000000052	2015-08-18	0.60
...
SELECT pg_catalog.setval('article_article_id_seq', 363, true);
...
SELECT pg_catalog.setval('city_city_id_seq', 124, true);
...
SELECT pg_catalog.setval('country_country_id_seq', 8, true);
...
581	643	10	hugorohner@hotmail.com
580	643	11	Hugo.Rohner@skidata.com
...
577	252	11	doris.kiefel@view-salzburg.at
578	252	11	info@view-salzburg.at
...
564	34	11	wolf.baur@view-salzburg.at
...
552	253	10	albert.kiefel@gmail.com
533	445	11	walter.riezinger@view-salzburg.at
551	253	11	albert.kiefel@view-salzburg.at
...
559	647	11	b.pallauf@pms-law.at
560	558	10	t.wallerstorfer@inn4you.eu
561	649	10	leonhard.schitter@sbg.at
...
SELECT pg_catalog.setval('email_email_id_seq', 591, true);
...
SELECT pg_catalog.setval('incoming_article_incoming_article_id_seq', 362, true);
...
147	119	642	0	2015-07-08	WP L 46	2015-07-30	0
...
152	57	642	0	2015-07-31	WP L 51	2015-08-18	0
153	108	642	0	2015-07-09	WP L 52	2015-08-18	1
155	139	253	0	2015-04-14	WP A 10	2015-09-01	0
...
SELECT pg_catalog.setval('incoming_delivery_incoming_delivery_id_seq', 160, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 2234, true);
...
SELECT pg_catalog.setval('organisation_organisation_id_seq', 252, true);
...
SELECT pg_catalog.setval('outgoing_article_outgoing_article_id_seq', 726, true);
...
253	165	642	\N	0	2015-03-27		2015-07-07	1
...
249	12	642	\N	0	2015-03-27		2015-07-03	1
...
252	12	642	\N	0	2015-03-26		2015-07-07	1
...
346	224	253	\N	0	2015-04-15	WP A 10	2015-09-07	1
...
352	250	574	\N	0	2015-08-25	WP U 13	2015-09-29	0
...
SELECT pg_catalog.setval('outgoing_delivery_outgoing_delivery_id_seq', 356, true);
...
34	2	46	226	345	Herr		Wolf	Baur	Tätigkeit: Waren	2015-06-21	1
44	2	31	221	441	Frau		Anita	Bernhofer	Tätigkeit: Waren	2015-09-09	1
252	3	24	6	252	Frau		Doris	Kiefel	Tätigkeit: Obfrau, Disposition	2015-06-20	1
...
253	3	97	462	345	Herr	Dipl.-Ing.	Albert	Kiefel	Tätigkeit: Administration	2015-06-20	1
...
558	2	51	510	345	Frau		Theresia	Wallerstorfer		2015-06-21	1
...
643	\N	54	586	345	Herr		Hugo	Rohner		2015-08-20	1
...
647	2	42	195	345	Frau	Dr.	Brigitta	Pallauf	Newsletter: ja	2015-06-21	1
649	2	122	579	345	Herr	Dr.	Leonhard	Schitter	Newsletter: nein	2015-06-21	1
...
SELECT pg_catalog.setval('person_person_id_seq', 654, true);
...
519	1	-MFts6Rb-1P_lyvHGTPRMA_YCXIF7yrF3sGY7463UpCTA8ss54FmA	michael.steingassner@view-salzburg.at
...
573	252	10	0049/8654/65801
574	252	10	0676/3252443
...
563	647	10	0664/8565665
428	36	10	0662/833754
427	36	10	0664/401202
564	34	10	0681/20901579
...
578	643	11	06246/888-2201
447	618	11	0662/875685-44
579	643	10	0664/88616396
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 590, true);
...
-- Completed on 2015-09-30 17:08:35
