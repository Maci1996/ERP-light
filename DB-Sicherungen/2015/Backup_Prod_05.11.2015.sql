...
-- Started on 2015-11-05 21:52:19
...
SELECT pg_catalog.setval('address_address_id_seq', 592, true);
...
SELECT pg_catalog.setval('article_article_id_seq', 376, true);
...
SELECT pg_catalog.setval('city_city_id_seq', 127, true);
...
SELECT pg_catalog.setval('email_email_id_seq', 601, true);
...
SELECT pg_catalog.setval('incoming_article_incoming_article_id_seq', 375, true);
...
SELECT pg_catalog.setval('incoming_delivery_incoming_delivery_id_seq', 164, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 2314, true);
...
SELECT pg_catalog.setval('organisation_organisation_id_seq', 253, true);
...
SELECT pg_catalog.setval('outgoing_article_outgoing_article_id_seq', 750, true);
...
SELECT pg_catalog.setval('outgoing_delivery_outgoing_delivery_id_seq', 367, true);
...
446	2	54	589	441	Frau		Cornelia	Robl	Tätigkeit: Waren	2015-10-21	1
...
602	2	42	165	345	Frau		Sabine	Zöpfl	Tätigkeit: Waren	2015-10-29	1
...
SELECT pg_catalog.setval('person_person_id_seq', 656, true);
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 595, true);
...
-- Completed on 2015-11-05 21:52:59
