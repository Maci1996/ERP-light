...
-- Started on 2015-12-05 17:11:05
...
SELECT pg_catalog.setval('address_address_id_seq', 596, true);
...
SELECT pg_catalog.setval('article_article_id_seq', 418, true);
...
SELECT pg_catalog.setval('city_city_id_seq', 128, true);
...
SELECT pg_catalog.setval('email_email_id_seq', 605, true);
...
SELECT pg_catalog.setval('incoming_article_incoming_article_id_seq', 417, true);
...
SELECT pg_catalog.setval('incoming_delivery_incoming_delivery_id_seq', 191, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 2542, true);
...
255	595	95	2	253	Unipark Mensa - Bodengraf GmbH		2015-11-28	1
...
SELECT pg_catalog.setval('organisation_organisation_id_seq', 258, true);
...
SELECT pg_catalog.setval('outgoing_article_outgoing_article_id_seq', 837, true);
...
253	165	642	\N	0	2015-03-27		2015-11-21	1
396	213	642	\N	0	2015-03-26		2015-11-21	1
...
SELECT pg_catalog.setval('outgoing_delivery_outgoing_delivery_id_seq', 408, true);
...
SELECT pg_catalog.setval('person_person_id_seq', 659, true);
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 602, true);
...
-- Completed on 2015-12-05 17:13:10
