...
-- Started on 2016-09-09 13:57:26
...
SELECT pg_catalog.setval('address_address_id_seq', 617, true);
...
SELECT pg_catalog.setval('article_article_id_seq', 732, true);
...
SELECT pg_catalog.setval('city_city_id_seq', 135, true);
...
661	18	10	ruth.amon@gmx.at
662	238	10	b.januschewsky@gmx.at
...
SELECT pg_catalog.setval('email_email_id_seq', 726, true);
...
SELECT pg_catalog.setval('incoming_article_incoming_article_id_seq', 731, true);
...
SELECT pg_catalog.setval('incoming_delivery_incoming_delivery_id_seq', 311, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 4270, true);
...
106	485	42	2	519	Loreto Kloster	HFA ok	2016-09-08	1
...
263	602	133	\N	519	Österreichische Gesellschaft für Dekubitusprävention (APUPA)		2016-02-19	1
...
267	611	135	7	253	Bergader Lager TS		2016-06-23	1
...
270	614	52	2	642	Freie Christengemeinde Bürmoos		2016-08-14	1
271	615	42	2	642	ARGE Beisl - ABC Gastronomie GmbH		2016-08-14	1
255	595	95	2	345	Bodengraf GmbH	IXSO	2016-08-17	1
193	512	31	2	519	Sozialwerk Hallein	zu löschen	2016-09-08	0
205	326	95	2	519	Ultrafrisch Salzburg GmbH	nicht mehr aktuell, löschen?	2016-09-08	1
...
214	520	42	2	519	Wiberg GmbH	nicht mehr aktuell, löschen?	2016-09-08	1
...
13	402	71	2	519	Bastian’s  im Designer Outlet Salzburg	nicht mehr aktuell, löschen?	2016-09-08	1
97	364	42	2	519	Lebenshilfe GmbH	nicht mehr aktuell, löschen?	2016-09-08	1
...
SELECT pg_catalog.setval('organisation_organisation_id_seq', 271, true);
...
SELECT pg_catalog.setval('outgoing_article_outgoing_article_id_seq', 1737, true);
...
SELECT pg_catalog.setval('outgoing_delivery_outgoing_delivery_id_seq', 757, true);
...
18	2	48	81	441	Frau		Ruth	Amon	Tätigkeit: Waren	2016-04-15	1
...
238	2	42	4	345	Frau	Mag.	Bärbel	Januschewsky	Tätigkeit: Disposition	2016-04-16	1
...
SELECT pg_catalog.setval('person_person_id_seq', 688, true);
...
664	18	10	0680/1168895
665	238	10	0676/3134610
666	238	10	0676/3134610
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 731, true);
...
-- Completed on 2016-09-09 13:57:58
