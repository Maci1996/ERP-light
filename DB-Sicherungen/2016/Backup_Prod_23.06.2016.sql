...
-- Started on 2016-06-23 09:33:57
...
SELECT pg_catalog.setval('address_address_id_seq', 611, true);
...
SELECT pg_catalog.setval('article_article_id_seq', 633, true);
...
672	252	11	info@view-salzburg.at
671	252	11	doris.kiefel@view-salzburg.at
...
684	656	10	safu1608@gmail.com
685	656	11	sabine.fuessl@view-salzburg.at
...
SELECT pg_catalog.setval('email_email_id_seq', 702, true);
...
SELECT pg_catalog.setval('incoming_article_incoming_article_id_seq', 632, true);
...
SELECT pg_catalog.setval('incoming_delivery_incoming_delivery_id_seq', 289, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 3873, true);
...
SELECT pg_catalog.setval('organisation_organisation_id_seq', 267, true);
...
SELECT pg_catalog.setval('outgoing_article_outgoing_article_id_seq', 1459, true);
...
SELECT pg_catalog.setval('outgoing_delivery_outgoing_delivery_id_seq', 692, true);
...
252	3	24	6	253	Frau		Doris	Kiefel	Tätigkeit: Obfrau, Disposition	2016-04-28	1
642	\N	119	572	519	Frau		Lisa	Traubenek	Tätigkeit: Administration, Waren	2016-04-29	1
656	2	42	592	519	Frau		Sabine	Füssl	Tätigkeit: Administration	2016-05-02	1
...
SELECT pg_catalog.setval('person_person_id_seq', 677, true);
...
252	1	t-MEfsCzAzel6bYGVjkN_tf4sUpx-fMqMYr-7pzVTMK6TSdFIR-IQ	doris.kiefel@view-salzburg.at
...
678	252	10	0049/8654/65801
677	252	10	0676/3252443
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 705, true);
...
-- Completed on 2016-06-23 09:34:35
