...
-- Started on 2016-05-31 19:17:49
...
SELECT pg_catalog.setval('address_address_id_seq', 609, true);
...
SELECT pg_catalog.setval('article_article_id_seq', 605, true);
...
SELECT pg_catalog.setval('city_city_id_seq', 134, true);
...
SELECT pg_catalog.setval('email_email_id_seq', 697, true);
...
SELECT pg_catalog.setval('incoming_article_incoming_article_id_seq', 604, true);
...
248	119	602	0	2016-03-04	WP S 83	2016-03-13	0
...
SELECT pg_catalog.setval('incoming_delivery_incoming_delivery_id_seq', 271, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 3692, true);
...
SELECT pg_catalog.setval('organisation_organisation_id_seq', 265, true);
...
SELECT pg_catalog.setval('outgoing_article_outgoing_article_id_seq', 1361, true);
...
SELECT pg_catalog.setval('outgoing_delivery_outgoing_delivery_id_seq', 641, true);
...
SELECT pg_catalog.setval('person_person_id_seq', 674, true);
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 702, true);
...
-- Completed on 2016-05-31 19:18:29
