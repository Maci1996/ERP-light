...
-- Started on 2016-10-13 19:23:52
...
SELECT pg_catalog.setval('address_address_id_seq', 652, true);
...
SELECT pg_catalog.setval('article_article_id_seq', 778, true);
...
SELECT pg_catalog.setval('city_city_id_seq', 140, true);
...
809	148	11	marijana.grabovac@stud.sbg.ac.at
...
857	405	10	bruno.prantl@zell-net.at
...
870	502	11	angela.simmel@rvs.at
...
824	238	10	b.januschewsky@gmx.at
...
887	722	10	j.boeck@menschen.leben.at
...
839	307	10	lixl.hubert@tele2.at
...
SELECT pg_catalog.setval('email_email_id_seq', 919, true);
...
SELECT pg_catalog.setval('incoming_article_incoming_article_id_seq', 777, true);
...
321	157	602	0	2016-09-19	WP S 109	2016-09-26	0
...
SELECT pg_catalog.setval('incoming_delivery_incoming_delivery_id_seq', 332, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 4952, true);
...
91	240	62	2	252	Landwirtschaftskammer Salzburg		2016-10-12	1
...
129	651	32	2	252	Palfinger AG	Webseite Ja\nKontakt über Walter Riezinger	2016-10-12	1
...
SELECT pg_catalog.setval('organisation_organisation_id_seq', 284, true);
...
SELECT pg_catalog.setval('outgoing_article_outgoing_article_id_seq', 1804, true);
...
SELECT pg_catalog.setval('outgoing_delivery_outgoing_delivery_id_seq', 797, true);
...
18	2	48	81	519	Frau		Ruth	Amon	25.03.2014	2016-10-04	1
...
51	2	5	78	519	Frau		Brigitte	Borbely	02.11.2009	2016-10-04	1
75	2	49	53	519	Herr		Günther	Derler	17.04.2013	2016-10-04	1
...
722	\N	\N	\N	519	Frau		Julia	Böck		2016-10-04	1
...
264	2	53	227	345	Frau		Ingrid	Koberger		2016-10-07	1
...
205	2	42	251	519	Frau		Maria	Hintsteiner	20.11.2011	2016-10-04	1
...
292	2	32	228	519	Frau		Erika	Lange	06.12.2011	2016-10-04	1
...
307	2	48	185	519	Herr		Hubert	Lixl	20.02.2008	2016-10-04	1
310	2	42	88	519	Frau		Bettina	Lorentschitsch, Msc MBA	23.01.2008	2016-10-04	1
315	2	48	26	519	Frau	Mag.	Elfriede	Mackinger	20.01.2009	2016-10-04	1
...
363	2	42	539	519	Herr	Mag.	Erwin	Niese	30.07.2010	2016-10-04	1
...
386	2	42	650	441	Frau	Mag.	Ulrike	Pfaffenberger	24.02.2012	2016-10-11	1
...
405	2	48	26	519	Herr		Bruno	Prantl	19.01.2009	2016-10-04	1
...
424	2	42	67	519	Herr	Dr.	Roland	Reichl	05.01.2013	2016-10-04	1
...
578	\N	140	645	252	Herr		Toni	Wieland		2016-10-08	1
...
502	2	42	546	519	Frau		Angela	Simmel	28.01.2010	2016-10-04	1
...
408	2	53	119	345	Frau		Elena	Proksch		2016-10-07	1
...
710	\N	137	632	252	Herr		Otmar	Wimmer		2016-09-25	1
...
148	2	42	77	519	Frau		Marijana 	Grabovac, Bakk.Phil.	Newsletter: ja, 24.06.2013	2016-10-04	1
672	2	42	608	519	Herr		Gerhard	Grosschädel	Newsletter: ja, 27.05.2015	2016-10-04	1
673	\N	42	113	519	Frau	Mag.	Friederike	Hurch	02.04.2012	2016-10-04	1
238	2	42	4	519	Frau	Mag.	Bärbel	Januschewsky	15.01.2013	2016-10-04	1
272	2	42	95	519	Frau		Herma	König	Newsletter: ja, 03.12.2013	2016-10-04	1
350	2	42	242	519	Herr		Michael	Mrazek	Newsletter: nein, 04.12.2013	2016-10-04	1
...
725	\N	42	648	252	Frau 		Elisabeth 	Hörl		2016-10-09	1
...
SELECT pg_catalog.setval('person_person_id_seq', 726, true);
...
838	578	11	0664/5607635
837	578	11	06219/6097
...
786	18	10	06232/4067
787	18	10	0680/1168895
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 842, true);
...
-- Completed on 2016-10-13 19:24:30
