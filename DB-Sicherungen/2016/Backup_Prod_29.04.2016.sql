...
-- Started on 2016-04-29 07:49:38
...
SELECT pg_catalog.setval('address_address_id_seq', 606, true);
...
659	591	10	elisabeth.apfelthaler@inode.at
660	652	10	drhleube@gmx.net
...
664	642	10	lisa_traubenek@yahoo.de
...
670	656	11	sabine.fuessl@view-salzburg.at
669	656	10	safu1608@gmail.com
672	252	11	info@view-salzburg.at
671	252	11	doris.kiefel@view-salzburg.at
674	644	10	alois.schwaiger@aon.at
...
SELECT pg_catalog.setval('email_email_id_seq', 674, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 3616, true);
...
656	2	42	592	345	Frau		Sabine	Füssl		2016-04-23	1
652	2	124	582	252	Herr	Dr.	Helmut	Leube	Newsletter: ja	2016-04-13	1
642	\N	119	572	345	Frau		Lisa	Traubenek	Tätigkeit: Administration, Waren	2016-04-20	1
252	3	24	6	253	Frau		Doris	Kiefel	Tätigkeit: Obfrau, Disposition	2016-04-28	1
644	\N	42	606	252	Herr	DI Dr.	Alois	Schwaiger	Tätigkeit: Waren	2016-04-28	1
...
591	2	42	169	441	Frau		Elisabeth	Apfelthaler (Wittich)	Tätigkeit: Waren	2016-04-11	1
...
SELECT pg_catalog.setval('person_person_id_seq', 671, true);
...
681	644	10	0664/73663498
620	36	10	0664-1800081
621	36	10	0662/833754
682	644	10	0662/824550
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 682, true);
...
-- Completed on 2016-04-29 07:50:25
