...
-- Started on 2016-07-22 10:35:39
...
SELECT pg_catalog.setval('address_address_id_seq', 612, true);
...
SELECT pg_catalog.setval('article_article_id_seq', 712, true);
...
SELECT pg_catalog.setval('email_email_id_seq', 709, true);
...
SELECT pg_catalog.setval('incoming_article_incoming_article_id_seq', 711, true);
...
291	119	642	0	2016-06-01	WP L 82	2016-06-28	0
...
298	267	642	0	2016-06-23	WP L 89	2016-07-07	0
300	267	642	0	2016-06-20	WP L 91	2016-07-07	0
299	267	642	0	2016-06-23	WP L 90	2016-07-07	1
303	119	642	0	2016-06-21	WP L 94	2016-07-07	0
...
SELECT pg_catalog.setval('incoming_delivery_incoming_delivery_id_seq', 305, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 4052, true);
...
157	324	56	2	519	Salzburg Schokolade GmbH		2016-04-18	1
...
9	327	105	2	253	anderskompetent Gmbh		2016-06-23	1
191	287	42	2	253	SOS-Kinderdorf Clearinghouse		2016-06-23	1
...
SELECT pg_catalog.setval('organisation_organisation_id_seq', 268, true);
...
SELECT pg_catalog.setval('outgoing_article_outgoing_article_id_seq', 1679, true);
...
703	126	642	\N	0	2016-06-07		2016-06-28	1
...
705	210	642	\N	0	2016-06-07		2016-06-29	0
706	148	642	\N	0	2016-06-07		2016-06-29	0
707	210	642	\N	0	2016-06-08		2016-06-29	0
708	44	642	\N	0	2016-06-08		2016-06-29	0
709	250	642	\N	0	2016-06-20		2016-06-29	1
710	12	642	\N	0	2016-06-20		2016-06-29	1
711	213	642	\N	0	2016-06-20		2016-06-29	0
...
729	12	642	\N	0	2016-06-27		2016-07-21	0
730	65	642	\N	0	2016-06-27		2016-07-21	0
728	213	642	\N	0	2016-06-27		2016-07-21	0
731	165	642	\N	0	2016-06-28		2016-07-21	0
732	213	642	\N	0	2016-06-28		2016-07-21	0
733	148	642	\N	0	2016-06-28		2016-07-21	0
734	65	642	\N	0	2016-06-28		2016-07-21	0
735	12	642	\N	0	2016-06-28		2016-07-21	0
\.
...
SELECT pg_catalog.setval('outgoing_delivery_outgoing_delivery_id_seq', 743, true);
...
668	3	134	\N	345	Herr		Siegfried	Huber    		2016-03-22	1
...
SELECT pg_catalog.setval('person_person_id_seq', 678, true);
...
252	1	bd2Ox6QKZ4agHyiSysxx0oScfzDfTUrj2nsZkgKnC_CVadfBGuF4M	doris.kiefel@view-salzburg.at
\.
...
659	668	11	0049/173/2948143
660	668	10	0049/170/2318678 
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 712, true);
...
-- Completed on 2016-07-22 10:36:08
