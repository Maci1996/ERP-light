...
-- Started on 2016-01-19 11:56:15
...
SELECT pg_catalog.setval('address_address_id_seq', 598, true);
...
SELECT pg_catalog.setval('article_article_id_seq', 511, true);
...
SELECT pg_catalog.setval('city_city_id_seq', 130, true);
...
614	36	10	regina.bayer-volkmann@pappas.at
615	36	10	
...
SELECT pg_catalog.setval('email_email_id_seq', 621, true);
...
SELECT pg_catalog.setval('incoming_article_incoming_article_id_seq', 510, true);
...
192	119	602	0	2015-10-21	WP S 74	2015-12-18	0
...
SELECT pg_catalog.setval('incoming_delivery_incoming_delivery_id_seq', 227, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 3027, true);
...
SELECT pg_catalog.setval('organisation_organisation_id_seq', 259, true);
...
SELECT pg_catalog.setval('outgoing_article_outgoing_article_id_seq', 1135, true);
...
412	213	602	\N	0	2015-10-29		2015-12-18	1
413	223	602	\N	0	2015-10-28		2015-12-18	1
414	12	602	\N	0	2015-10-28		2015-12-18	1
...
SELECT pg_catalog.setval('outgoing_delivery_outgoing_delivery_id_seq', 543, true);
...
36	2	53	523	252	Frau Dir. KR		Regina	Bayer-Volkmann		2016-01-15	1
...
SELECT pg_catalog.setval('person_person_id_seq', 661, true);
...
607	330	11	
608	330	11	
613	36	10	0662/833754
614	36	10	0664/4012021
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 619, true);
...
-- Completed on 2016-01-19 11:59:05
