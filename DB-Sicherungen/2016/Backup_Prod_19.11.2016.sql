...
-- Started on 2016-11-19 15:36:41
...
SELECT pg_catalog.setval('address_address_id_seq', 653, true);
...
SELECT pg_catalog.setval('email_email_id_seq', 924, true);
...
SELECT pg_catalog.setval('logging_logging_id_seq', 5005, true);
...
591	2	42	169	519	Frau		Elisabeth	Apfelthaler (Wittich)	Tätigkeit: Waren	2016-10-19	1
...
SELECT pg_catalog.setval('person_person_id_seq', 727, true);
...
SELECT pg_catalog.setval('telephone_telephone_id_seq', 848, true);
...
-- Completed on 2016-11-19 15:37:15
